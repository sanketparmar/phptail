...
class PHPTail {
	...
	private $filename = "";
         ...
         */
        public function __construct($log_path, $log_file, $defaultUpdateTime = 15000, $maxSizeToLoad = 2097152) {
                $this->log = $log_path."/".$log_file;
                ...
                <html xmlns="http://www.w3.org/1999/xhtml">
                        <head>
                                ...
                                <script type="text/javascript">
                                        ...
                                        function updateLog() {
                                                $.getJSON('?file='+ filename +'&ajax=1&lastsize='+lastSize + '&grep='+grep + '&invert='+invert, function(data) {
                                                        lastSize = data.size;
